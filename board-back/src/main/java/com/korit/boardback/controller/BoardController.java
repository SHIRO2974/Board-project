...
import com.korit.boardback.dto.response.RespBoardSearchDto;
...
public class BoardController {
    ...
    public ResponseEntity<?> searchBoardList(@ModelAttribute ReqBoardListSearchDto dto) {
        ...
        int totalBoardListCount = boardService.getBoardCountBySearchText(dto.getSearchText());
        ...
        RespBoardSearchDto respBoardSearchDto =
                RespBoardSearchDto.builder()
                        .page(dto.getPage())
                        ...
                        .build();
        return ResponseEntity.ok().body(boardService.getBoardListSearchBySearchOption(dto));
    }
